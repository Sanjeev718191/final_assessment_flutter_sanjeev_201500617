    ...
    return Scaffold(
      body: SafeArea(
        child: Padding(
          ...
          child: ListView(
            children: [
              Text("Login", style: TextStyle(fontSize: 42, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 83, 0, 98))),
              SizedBox(
                height: 50,
              ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Email ID",
                  errorText: emailVal ? 'Email Can\'t Be Empty' : null,
                  hintStyle: TextStyle(fontSize: 18),
                  border: UnderlineInputBorder(),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    setState(() {
                      ...
                      _email.text.isEmpty ? emailVal = true : emailVal = false;
                      
                    });
                    if(nameVal == false && emailVal == false){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return TraningCompletion(title: _name.text,);}));
                    }

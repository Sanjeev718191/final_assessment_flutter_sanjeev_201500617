      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            Text("You have completed Hybrid Mobile app devleopment Course.", textDirection: TextDirection.ltr,
            style: new TextStyle(fontSize: 20.0),
            maxLines: 2,),
            Text("Instructor Name", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold),),
            Text("Pankaj Kapoor", style: TextStyle(fontSize: 20,color: Color.fromARGB(255, 33, 61, 243), ),),
